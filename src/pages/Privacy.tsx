  ...
  sections: [
    {
      ...
      title: "목적",
      content:
        "셰프토리(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.",
    },
    {
      article: 2,
      title: "개인정보 처리의 원칙",
      ...
      <main className="container mx-auto px-4 pt-28 pb-16">
        <div className="prose prose-slate max-w-3xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            시행일: {privacyPolicyData.effectiveDate}
          </p>
          {privacyPolicyData.sections.map((section: any) => (
            <section key={section.article}>
              ...
              {section.responsiblePerson && (
                <ul>
                  <li>책임자: {section.responsiblePerson.name}</li>
                  <li>직책: {section.responsiblePerson.position}</li>
                  <li>전화: {section.responsiblePerson.phone}</li>
                  <li>이메일: {section.responsiblePerson.email}</li>
                </ul>
              )}
              <hr />
            </section>
